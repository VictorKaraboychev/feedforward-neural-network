...
public class NetworkConfiguration {
	...
	public void addFullyConnectedLayer(Vector3 neurons, ActivationFunction activation) {
		this.networkLayers++;
	...
	public void addConvolutionalLayer(int depth, int kernelFilter, int stride, ActivationFunction activation) {
		this.networkLayers++;
		this.outputIndex = this.networkLayers - 1;
